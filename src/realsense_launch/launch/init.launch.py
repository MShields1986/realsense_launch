...
realsense_node_params = [{'name': 'serial_no',                    'default': '',            'description': 'choose device by serial number'},
                         ...
                         {'name': 'camera_name',                  'default': 'rs/camera',   'description': 'camera unique name'},
                         {'name': 'camera_namespace',             'default': 'rs/camera',   'description': 'camera namespace'},
                         ...
                         {'name': 'rgb_camera.color_profile',     'default': '1280x720x30', 'description': 'color image size and rate'},
                         {'name': 'depth_module.depth_profile',   'default': '848x480x30',  'description': 'depth image size and rate'},
